    ...
    fn create_template_server_card(
        ...
        let server_card = ServerCardView::new(
            ...
            template
                .description
                .clone()
                .or_else(|| Some(i18n::t!("Available to install").to_string())),
                ...
                Align::new(
                    Flex::column()
                        ...
                        .with_child(
                            appearance
                                .ui_builder()
                                .wrappable_text(i18n::t!("No search results found"), true)
                                .with_style(style::description_text(appearance))
                                .build()
                                .finish(),
                        )
        ...
        for provider in MCPProvider::iter() {
            ...
            let server_card = ServerCardView::new(
                ...
                installation
                    ...
                    .description
                    .clone()
                    .or_else(|| Some(i18n::t!("Detected from config file").to_string())),
