...
impl AgentManagementView {
    ...
    fn create_status_dropdown(
        ...
        Self::setup_filter_menu(&mut dropdown, i18n::t!("Status").to_string(), ctx);
    ...
    fn create_source_dropdown(
        ...
        let mut dropdown = Dropdown::new(ctx);
        Self::setup_filter_menu(&mut dropdown, i18n::t!("Source").to_string(), ctx);
    ...
    fn build_source_dropdown_items() -> Vec<MenuItem<DropdownAction>> {
        ...
        let mut items = vec![MenuItem::Item(
            MenuItemFields::new(i18n::t!("All").to_string()).with_on_select_action(
    ...
    fn create_created_on_dropdown(
        ...
        let mut dropdown = Dropdown::new(ctx);
        Self::setup_filter_menu(&mut dropdown, i18n::t!("Created on").to_string(), ctx);
        ...
        let items = vec![
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Last 24 hours").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Past 3 days").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Last week").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
    ...
    fn create_artifact_dropdown(
        ...
        let mut dropdown = Dropdown::new(ctx);
        Self::setup_filter_menu(&mut dropdown, i18n::t!("Has artifact").to_string(), ctx);
        ...
        let items = vec![
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Pull Request").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Plan").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("Screenshot").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
            ...
            MenuItem::Item(
                MenuItemFields::new(i18n::t!("File").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
    ...
    fn create_harness_dropdown(
        ...
        let mut dropdown = Dropdown::new(ctx);
        Self::setup_filter_menu(&mut dropdown, i18n::t!("Harness").to_string(), ctx);
    ...
    fn create_environment_dropdown(
        ...
        Self::setup_searchable_filter_menu(&mut dropdown, i18n::t!("Environment").to_string(), ctx);
    ...
    fn create_creator_dropdown(
        ...
        let mut dropdown = FilterableDropdown::new(ctx);
        Self::setup_searchable_filter_menu(&mut dropdown, i18n::t!("Created by").to_string(), ctx);
        dropdown
    }
    ...
    fn update_environment_dropdown(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        self.environment_dropdown.update(ctx, |dropdown, ctx| {
            ...
            items.push(MenuItem::Item(
                MenuItemFields::new(i18n::t!("None").to_string()).with_on_select_action(
                    DropdownAction::select_action_and_close(
    ...
    fn render_session_status_label(
        ...
        let (label_text, tooltip_text_opt) = match session_status {
            SessionStatus::Expired => (
                i18n::t!("Session expired").to_string(),
                Some(SESSION_EXPIRED_TEXT),
            ),
            SessionStatus::Unavailable => (i18n::t!("No session available").to_string(), None),
            ...
            if let Some(harness) = entry.display.harness {
                metadata_parts.push(
                    i18n::t!(
                        ...
                        display_name = availability.display_name_for(harness).to_string()
                    )
                    .to_string(),
                );
            }
        ...
        if let Some(executor) = &entry.display.executor {
            ...
            if !same_as_creator {
                if let Some(name) = executor.name.as_deref().or(executor.uid.as_deref()) {
                    ...
                    metadata_parts
                        .push(i18n::t!("{label}: {name}", label = label, name = name).to_string());
                }
            }
        }
    ...
    fn render_cloud_loading_icon(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.loading_icon_mouse_state.clone(), move |mouse_state| {
            ...
            if mouse_state.is_hovered() {
                let tooltip = ui_builder
                    .tool_tip(i18n::t!("Loading cloud agent runs").to_string())
                    .build()
                    .finish();
                stack.add_positioned_overlay_child(
                    tooltip,
