...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            i18n::t!("Increase notebook font size").to_string(),
        ...
        EditableBinding::new(
            ...
            i18n::t!("Decrease notebook font size").to_string(),
        ...
        EditableBinding::new(
            ...
            i18n::t!("Reset notebook font size").to_string(),
        ...
        EditableBinding::new(
            ...
            i18n::t!("Focus Terminal Input from Notebook").to_string(),
...
impl NotebookView {
    ...
    fn overflow_menu_items(&self, ctx: &AppContext) -> Vec<MenuItem<NotebookAction>> {
        ...
        if let Some(ai_document_id) = self.active_notebook_data.as_ref(ctx).ai_document_id(ctx) {
            menu_items.push(
                MenuItemFields::new(i18n::t!("Attach to active session").to_string())
                ...
                == UserAppInstallStatus::Detected
        {
            if let Some(link) = self.notebook_link(ctx) {
                if let Ok(url) = Url::parse(&link) {
                    menu_items.push(
                        MenuItemFields::new(i18n::t!("Open on Desktop").to_string())
                ...
                action_row.add_child(
                    Align::new(
                        appearance
                            ...
                            .with_tooltip(move || {
                                ui_builder
                                    .tool_tip(i18n::t!("Restore notebook from trash").to_string())
                                    .build()
                                    .finish()
                            })
                    ...
                    Container::new(
                        Align::new(
                            appearance
                                ...
                                .with_text_label(i18n::t!("Copy to Personal").to_string())
                                .build()
                                .on_click(|ctx, _, _| {
                ...
                Align::new(
                    appearance
                        ...
                        .with_tooltip(move || {
                            ui_builder
                                .tool_tip(
                                    i18n::t!("Copy notebook contents to your clipboard")
                                        .to_string(),
                                )
                                .build()
                                .finish()
                        })
                        .with_text_label(i18n::t!("Copy All").to_string())
                        .build()
                        .on_click(|ctx, _, _| {
                ...
                Container::new(
                    Align::new(
                        appearance
                            ...
                            .with_tooltip(move || {
                                ui_builder
                                    .tool_tip(i18n::t!("Refresh notebook").to_string())
                                    .build()
                                    .finish()
                            })
...
impl View for NotebookView {
    ...
    fn accessibility_contents(&self, ctx: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new_without_help(
            i18n::t!("{arg0} notebook", arg0 = self.title(ctx)).to_string(),
