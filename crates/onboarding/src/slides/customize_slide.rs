...
impl CustomizeUISlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(i18n::t!("Customize your Warp"))
        ...
        let subtitle = FormattedTextElement::from_str(
            i18n::t!("Tailor your features and UI to your working style."),
    ...
    fn render_tab_styling_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: i18n::t!("Tab styling"),
                is_expanded: is_selected,
                is_left_selected: ui.use_vertical_tabs,
                left_label: i18n::t!("Vertical"),
                right_label: i18n::t!("Horizontal"),
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            ...
            if is_agent {
                chips.push(ChipSpec {
                    label: i18n::t!("Conversation history"),
            ...
            chips.push(ChipSpec {
                label: i18n::t!("Global file search"),
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: i18n::t!("Tools panel"),
                is_expanded: is_selected,
                is_left_selected: ui.tools_panel_enabled(&intention),
                left_label: i18n::t!("Enabled"),
                right_label: i18n::t!("Disabled"),
