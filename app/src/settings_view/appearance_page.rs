...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        i18n::t!("Start Input at the Top").to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        i18n::t!("Pin Input to the Top").to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        i18n::t!("Pin Input to the Bottom").to_string(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        i18n::t!("Toggle Input Mode (Warp/Classic)").to_string(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                i18n::t!("Always show tab bar").to_string(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                i18n::t!("Hide tab bar if fullscreen").to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                i18n::t!("Only show tab bar on hover").to_string(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
    ...
    fn render(
        ...
        Align::new(
            appearance
                .ui_builder()
                .link(
                    i18n::t!("Create your own custom theme").to_string(),
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let show_dock_icon_toggle = render_body_item::<AppearancePageAction>(
            i18n::t!("Show Warp in Dock").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            i18n::t!("Open new windows with custom size").to_string(),
            None,
            LocalOnlyIconState::for_setting(
            ...
            return Flex::column()
                .with_child(
                    Container::new(render_body_item_label::<AppearancePageAction>(
                        i18n::t!("Window Opacity:").to_string(),
                        None,
                        None,
                        LocalOnlyIconState::Hidden,
...
impl SettingsWidget for WindowBlurWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<AppearancePageAction>(
                i18n::t!("Window Blur Radius: {blur_value}", blur_value = blur_value).to_string(),
                Some(label_info),
                LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WindowBlurTextureWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            i18n::t!("Use Window Blur (Acrylic texture)").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Tools panel visibility is consistent across tabs").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Dim inactive panes").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Focus follows mouse").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        let enabled = block_list_settings
            ...
            .value();
        render_body_item::<AppearancePageAction>(
            i18n::t!("Show Jump to Bottom of Block button").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Show block dividers").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Show ligatures in terminal").to_string(),
            Some(AdditionalInfo {
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Blinking cursor").to_string(),
            None,
            LocalOnlyIconState::for_setting(
                CursorBlinkEnabled::storage_key(),
                CursorBlinkEnabled::sync_to_cloud(),
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Show tab indicators").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for PreserveActiveTabColorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Preserve active tab color for new tabs").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Use vertical tab layout").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowVerticalTabPanelInRestoredWindowsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Show vertical tabs panel in restored windows").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for HideTitleBarSearchBarInVerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Hide search bar in vertical tab layout").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for UseLatestUserPromptAsConversationTitleInTabNamesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            i18n::t!("Use latest user prompt as conversation title in tab names").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for EditToolbarWidget {
    ...
    fn render(
        ...
        let label = render_body_item_label::<AppearancePageAction>(
            i18n::t!("Header toolbar layout").to_string(),
            None,
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
...
impl SettingsWidget for AltScreenPaddingWidget {
    ...
    fn render(
        ...
        let theme = appearance.theme();
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            i18n::t!("Use custom padding in alt-screen").to_string(),
            Some(AdditionalInfo {
