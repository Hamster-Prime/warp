...
impl View for EmptyTrashConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let confirm_button = appearance
            ...
            .with_centered_text_label(i18n::t!("Yes, empty trash").to_string())
        ...
        Dialog::new(
            i18n::t!("Are you sure you want to empty the trash?").to_string(),
            Some(i18n::t!("This action cannot be undone.").to_string()),
            UiComponentStyles {
                width: Some(460.),
