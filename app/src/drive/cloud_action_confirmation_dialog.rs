...
impl CloudActionConfirmationDialog {
    ...
    fn title_text(&self) -> String {
        match self.variant {
            ...
            | CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                i18n::t!("Are you sure you want to leave this team?").to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                i18n::t!("Are you sure you want to delete this team?").to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                i18n::t!("Are you sure you want to remove this member?").to_string()
            }
    ...
    fn body_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                i18n::t!("You will need to be reinvited in order to rejoin.").to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => i18n::t!(
            ...
            .to_string(),
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => i18n::t!(
            ...
            .to_string(),
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => i18n::t!(
    ...
    fn confirm_button_text(&self) -> String {
        match self.variant {
            ...
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                i18n::t!("Remove Member").to_string()
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
