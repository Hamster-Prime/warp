...
impl GrabEditAccessModal {
    ...
    pub fn render_modal(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let description = Text::new(
            i18n::t!("If you take edit controls, the current editor will be forced into view mode"),
        ...
        Dialog::new(
            i18n::t!("This notebook is currently being edited").to_string(),
            None,
        ...
        .with_bottom_row_child(
            ui_builder
                ...
                .with_text_label(i18n::t!("Edit anyway").to_string())
                .build()
                .on_click(|ctx, _, _| {
