    ...
    fn render_text_column(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = ui_builder
            .span(if self.visibility_state == VisibilityState::Speedbump {
                i18n::t!("Index Codebase?")
            } else {
                i18n::t!("Indexing codebase")
            })
        ...
        let body = ui_builder
            .span(i18n::t!("Indexing helps agents quickly understand context and provide targeted solutions. Code is never stored on the server."))
            .with_style(UiComponentStyles {
    ...
    pub fn render_codebase_index_speedbump_banner(
        ...
        if self.visibility_state == VisibilityState::Speedbump {
            ...
            let checkbox_text = ui_builder
                .span(i18n::t!("Allow automatic indexing"))
                .with_style(UiComponentStyles {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(i18n::t!("Don't show again").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(i18n::t!("Index codebase").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(i18n::t!("View status").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
