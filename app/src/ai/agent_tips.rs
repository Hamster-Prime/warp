...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: i18n::t!("Store reusable workflows, notebooks, and prompts in your").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Enter a new prompt to redirect the agent while it's running.").to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        ...
        AgentTip {
            description: i18n::t!("Add agent profiles to customize permissions and models per session.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Right-click a block to fork the conversation from that point.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Right-click a block to copy a conversation's output.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Drag an image into the pane to attach it as agent context.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Prompt the agent to control interactive tools like node, python, postgres, gdb, or vim.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Use the `oz` command to run an Oz agent in headless mode, useful for remote machines.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Right-click selected text to attach it as agent context.").to_string(),
            link: Some("https://docs.warp.dev/agent-platform/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        ...
        AgentTip {
            description: i18n::t!("Use `AGENTS.md` or `CLAUDE.md` to apply project-scoped rules.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Paste a URL to attach that webpage as context for the agent.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Warpify a remote SSH session to enable Oz inside that environment.").to_string(),
        ...
        AgentTip {
            description: i18n::t!("Switch agent profiles to quickly change models and agent permissions.").to_string(),
            link: Some("https://docs.warp.dev/agent-platform/capabilities/agent-profiles-permissions".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        ...
        AgentTip {
            description: i18n::t!("Type `&` or use the handoff chip to move a local conversation to the cloud.").to_string(),
            link: None,
            binding_name: None,
            action: None,
        ...
        AgentTip {
            description: i18n::t!("Enable desktop notifications to get an alert when an agent needs your attention.").to_string(),
