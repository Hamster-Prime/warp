    ...
    fn context_menu_items(
        ...
        if is_remote {
            ...
            match item {
                FileTreeItem::File { .. } => {
                    ...
                    if !is_file_content_binary(&path_local) {
                        items.extend([
                            MenuItemFields::new(i18n::t!("Open in new pane").to_string())
                                .with_on_select_action(FileTreeAction::OpenInNewPane {
                                    id: id.clone(),
                                })
                                .into_item(),
                            MenuItemFields::new(i18n::t!("Open in new tab").to_string())
                        ...
                        items.push(
                            MenuItemFields::new(i18n::t!("Open file").to_string())
                ...
                FileTreeItem::DirectoryHeader { .. } => {
                    items.push(
                        MenuItemFields::new(i18n::t!("New file").to_string())
            ...
            if !is_repo_root_dir {
                ...
                items.push(
                    MenuItemFields::new(i18n::t!("Delete").to_string())
        ...
        if self.has_terminal_session {
            ...
            items.push(
                MenuItemFields::new(i18n::t!("Attach as context").to_string())
        ...
        items.extend([
            MenuItemFields::new(i18n::t!("Copy path").to_string())
                ...
                .into_item(),
            MenuItemFields::new(i18n::t!("Copy relative path").to_string())
