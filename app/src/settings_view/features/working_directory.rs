    ...
    fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
        ...
        if config.advanced_mode {
            let items = Flex::column()
                ...
                .with_children([
                    ui_builder.label(i18n::t!("New window")).build().finish(),
                    render_row(
                    ...
                    ui_builder.label(i18n::t!("New tab")).build().finish(),
                    render_row(
                    ...
                    ui_builder.label(i18n::t!("Split pane")).build().finish(),
                    render_row(
...
fn create_editor(
    ...
    let editor = {
        ...
        ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(i18n::t!("Directory path").to_string(), ctx);
            editor
        })
    };
    let initial_value = {
